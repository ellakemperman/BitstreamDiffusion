...
def get_config():
    ...
    cfg.evaluation.out_dir = f"runs/{cfg.experiment}/ablation_ffhq_schedule"
    ...
    out_path = "../data/image_testing/ffhq0/pi_adaptive/99NFE/data/"
    gamma = 0.185

    for nfe in [64, 128, 256]:
        for sampler_name in ["ddim_pi", "heun_pi"]:
            ...
            pi_schedule_path = out_path + "_t.csv"
